# FP32 Matrix Multiplication Benchmarks

Implementations and benchmarks for accelerated FP32 general matrix multiplication. The project has been exercised with a CUDA-enabled NVIDIA GPU on a Linux environment.

## Dependencies
- Eigen 3.4.0, placed at `lib/eigen-3.4.0`. Obtain this dependency through your approved package or artifact source.
