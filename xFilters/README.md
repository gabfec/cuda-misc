...
3. You will be asked to type the filter name. Supported filters are as follows:
    ...
    ### Supported Filters
    #### Sharpen
    <img src="data/8k.jpg" width="390" height="250">
    <img src="data/Sharpen_filtered_img.png" width="390" height="250">

    #### High-pass (edge detection)
    <img src="data/8k.jpg" width="390" height="250">
    <img src="data/High-pass_filtered_img.png" width="390" height="250">

    #### Low-pass 
    <img src="data/8k.jpg" width="390" height="250">
    <img src="data/Low-pass_filtered_img.png" width="390" height="250">

    #### Gaussian (image blurring)
    <img src="data/8k.jpg" width="390" height="250">
    <img src="data/Gaussian_filtered_img.png" width="390" height="250">

    #### Derivative of Gaussian (edge detection)
    <img src="data/8k.jpg" width="390" height="250">
    <img src="data/d_Gaussian_filtered_img.png" width="390" height="250">
...
Image loading and writing source is included locally in `lib`. Its applicable license text remains in the corresponding source files.
